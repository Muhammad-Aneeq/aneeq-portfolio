  ...
  return (
    <section className={cn("border-t border-border pt-12", className)}>
      <SectionHeader
        ...
        description="Sent through the form below and published unedited, beyond trimming for length."
      />
  ...
  return (
    <Reveal>
      <p className={cn("max-w-read text-sm leading-relaxed text-faint", className)}>
        Nothing published here yet. Entries appear once someone has sent one and I have
        added it, so this space stays empty rather than filling with examples.
      </p>
    </Reveal>
  );
}
